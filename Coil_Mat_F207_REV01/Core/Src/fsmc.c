...
static void HAL_FSMC_MspDeInit(void){
  ...
  */
  ...
  HAL_GPIO_DeInit(GPIOE, M_FSMC_LCD_DB4_Pin|M_FSMC_LCD_DB5_Pin|M_FSMC_LCD_DB6_Pin|M_FSMC_LCD_DB7_Pin
                          |M_FSMC_LCD_DB8_Pin|M_FSMC_LCD_DB9_Pin|M_FSMC_LCD_DB10_Pin|M_FSMC_LCD_DB11_Pin
                          |M_FSMC_LCD_DB12_Pin);

  HAL_GPIO_DeInit(GPIOD, M_FSMC_LCD_DB13_Pin|M_FSMC_LCD_DB14_Pin|M_FSMC_LCD_DB15_Pin|M_FSMC_LCD_RS_Pin
                          |M_FSMC_LCD_DB0_Pin|M_FSMC_LCD_DB1_Pin|M_FSMC_LCD_DB2_Pin|M_FSMC_LCD_DB3_Pin
                          |M_FSMC_LCD_NRD_Pin|M_FSMC_LCD_NWR_Pin|M_FSMC_LCD_NCS_Pin);
